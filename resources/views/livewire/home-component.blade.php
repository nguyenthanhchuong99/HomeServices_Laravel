    ...
    <section class="tp-banner-container">
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="slidevertical" data-stamount="1" data-masterspeed="1000"
            ...
            <div id="boxes-carousel">
                ...
                <div>
                    <a class="g-list" href="{{ route('home.service_details',['service_slug'=>$aservice->slug]) }}">
                        <div class="img-hover">
                            <img src="{{asset('images/services/thumbnails')}}/{{ $aservice->image }}" alt="" class="img-responsive">
                        </div>
